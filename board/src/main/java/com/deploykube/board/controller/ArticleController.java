...
import com.deploykube.board.dto.response.ArticleWithCommentsResponse;
import com.deploykube.board.dto.security.BoardPrincipal;
...
public class ArticleController {
    ...
    public String updateArticle(@PathVariable Long articleId,
        ...
        articleService.updateArticle(articleId, articleRequest.toDto(boardPrincipal.toDto())); // request, response 는 controller, toDto 는 service layer
